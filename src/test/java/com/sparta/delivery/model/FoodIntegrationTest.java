    ...
    class RegisterRestaurants {
        ...
        void test1() throws JsonProcessingException {
            ...
            ResponseEntity<Object> response = restTemplate.postForEntity(
                    "/restaurant/" + restaurantId + "/foods/register",
                    request,
                    Object.class);
        ...
        void test3() {
            ...
            assertEquals(food2.getName(), food1Response.getName());
            assertEquals(food2.getPrice(), food1Response.getPrice());
            ...
            assertEquals(food3.getName(), food2Response.getName());
            assertEquals(food3.getPrice(), food2Response.getPrice());
            ...
            assertEquals(food4.getName(), food3Response.getName());
            assertEquals(food4.getPrice(), food3Response.getPrice());
    ...
    class FoodName {
        ...
        void test4() throws JsonProcessingException {
            ...
            ResponseEntity<Object> foodResponse = restTemplate.postForEntity(
                    "/restaurant/" + restaurant2Id + "/foods/register",
                    foodRequest,
                    Object.class);
